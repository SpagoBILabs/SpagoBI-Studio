...
public class NewWorkbenchBirtAction implements IWorkbenchWindowActionDelegate {

	private IViewPart view = null;
	
	ISelection selection;

	private static Logger logger = LoggerFactory.getLogger(NewWorkbenchBirtAction.class);
