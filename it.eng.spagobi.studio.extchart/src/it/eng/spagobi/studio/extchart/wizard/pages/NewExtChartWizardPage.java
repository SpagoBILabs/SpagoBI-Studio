 ...
 **/
package it.eng.spagobi.studio.extchart.wizard.pages;
...
public class NewExtChartWizardPage extends WizardPage {
	...
	private static Logger logger = LoggerFactory.getLogger(NewExtChartWizardPage.class);
	private IWorkbench workbench;

	public NewExtChartWizardPage( IWorkbench _workbench, String pageName) {
		super(pageName);
		setTitle("New Ext Chart ...");
	...
	public void createControl(Composite parent) {
		...
		try{
			//Type 
			final List chartTypes = ExtChartConfigurations.getConfiguredChartTypes();
			...
			for (Iterator iterator = chartTypes.iterator(); iterator.hasNext();) {
				...
				compImage.addPaintListener(new PaintListener() {
					public void paintControl(PaintEvent e) {
						...
						try {
							String imagePath=ExtChartUtils.getChartImagePath(t.toUpperCase());
							InputStream is=ExtChartUtils.getInputStreamFromResource(imagePath);
	...
	public static void setSelectedType(String selectedType) {
		NewExtChartWizardPage.selectedType = selectedType;
	}
