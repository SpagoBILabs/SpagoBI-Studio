...
public class NewWorkbenchJasperAction implements IWorkbenchWindowActionDelegate {

	private IViewPart view = null;

	ISelection selection;

	private static Logger logger = LoggerFactory.getLogger(NewWorkbenchJasperAction.class);
