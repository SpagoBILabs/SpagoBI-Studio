...
**/
package it.eng.spagobi.studio.highchart.configuration;
...
public class HighChartConfigurations {

	public static final String INFO_FILE = "it/eng/spagobi/studio/highchart/configuration/highcharts.xml";

	private static Logger logger = LoggerFactory.getLogger(HighChartConfigurations.class);
	...
	public static InputStream getInputStreamFromResource(String resourcePath) throws IOException {
		Bundle b = Platform.getBundle(it.eng.spagobi.studio.highchart.Activator.PLUGIN_ID);
