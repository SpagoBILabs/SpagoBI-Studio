...
public class NewWorkbenchDocumentCompositionAction implements IWorkbenchWindowActionDelegate {

	private IViewPart view = null;

	ISelection selection;

	private static Logger logger = LoggerFactory.getLogger(NewWorkbenchDocumentCompositionAction.class);
